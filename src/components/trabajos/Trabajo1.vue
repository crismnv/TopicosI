<template>
  <div class="ed-item ed-container main-center main-trabajo1">
    ...
    <div 
    class="ed-item ed-container main-center cross-center  main-trabajo1__ingreso-datos"
    v-if="arbolElegido==3" ma>
      <h2 class="ed-item  main-center cross-center main-trabajo1__instrucciones">Ingrese la información separada por comas(,) y sin espacios</h2>
    ...
    <div 
    id="mynetwork" 
    class=" ed-item l-70  main-trabajo1__grafico"
    ></div>
