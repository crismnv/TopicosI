<template>
  <div class="ed-item ed-container main-center main-trabajo2">
      ...
      >Sale</a>
      <div id="ventanillas" class="ed-item l-70  main-trabajo2__grafico">
      </div>
      <div id="monticulo" class="ed-item l-90  main-trabajo2__grafico">
      </div>
  </div>
...
export default {
  ...
  methods:
  {
    ...
    nuevoCliente(nivelTarjeta)
    {
      ...
      if(this.banco.cola.cantidadDeClientes() > 0 )  
        this.iniciarVisMonticulo(this.banco.cola.datosVis())
      // console.log(this.banco.cola.datosVis())
      
      // console.log(this.banco.cola.clientes)
    },
    // cambiarValorTarjeta(e)
    // {
    //     this.tarjetaSeleccionada = e.target.selectedIndex
    //     alert(this.tarjetaSeleccionada)
    // },
    // cambiarVentanilla(ev)
    // {
    //     this.ventanillaSeleccionada = ev.target.selectedIndex
    //     alert(this.ventanillaSeleccionada)
    // },
  ...
  mounted()
  {
    let data = this.banco.ventanillaVis()
    this.iniciarVisVentanilla(data)
//     this.banco.nuevoCliente(1)
//     this.banco.nuevoCliente(4)
//     this.banco.nuevoCliente(2)
//     this.banco.nuevoCliente(1)
//     this.banco.nuevoCliente(4)
//     this.banco.nuevoCliente(2)
//     this.banco.nuevoCliente(3)
//     this.banco.nuevoCliente(1)
//     this.banco.nuevoCliente(2)
//     this.banco.nuevoCliente(1)
//     this.banco.nuevoCliente(4)
//     this.banco.nuevoCliente(2)
//     // this.banco.cola.sacar()
//     // this.banco.nuevoCliente(4)
